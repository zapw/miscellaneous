...
#sed -i -e 's|\(${exec_prefix}\)/lib\b|\1/%{_lib}|' configure
...
if [ "$SMP" != "" ]; then
    export MAKE="make -j$SMP CFLAGS=-fno-strict-aliasing CXXFLAGS=-fno-strict-aliasing"
else
    export MAKE="make CFLAGS=-fno-strict-aliasing CXXFLAGS=-fno-strict-aliasing"
fi
