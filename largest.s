...
### This program will find the largest value in the array
 askquestion: # not used
 .ascii "enter the stupid 7 numbers\n\0"
 askquestion_2: #not used
 ...
 numbernotfound:
  .string "number not found nigga\n"
 continue_fmt: # not used
  .string " %c"
 continuey: # not used
...
#call fprintf
  ...
  call fscanf
   ...
   movq $filename_write, %rdi
   movq $openmode_write, %rsi
   call fopen
   movq %rax, -104(%rbp)
